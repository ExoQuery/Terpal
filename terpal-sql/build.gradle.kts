...
//
//    val containerInstance = PostgreSQLContainer("postgres:16.3-alpine3.20").apply {
...
//class ExecWait: DefaultTask {
//    lateinit var String command
//    lateinit var String ready
//    lateinit var String directory
//
//  @TaskAction
//  fun spawnProcess() {
